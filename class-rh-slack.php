<?php
/*
 * Plugin Name: Slack Notifications for WordPress
 * Plugin URI: https://github.com/kingkool68/wordpress-slack-notifications
 * Description: Send notifications from WordPress to Slack
 * Version: 0.1
